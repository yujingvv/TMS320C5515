...
static wiener_state_t g_wiener;
static vad_state_t    g_vad;

static q15_t      g_windowed[N_FFT];
static q15_cplx_t g_full_spec[N_FFT];
static q15_cplx_t g_half_spec[N_BINS];
static q15_cplx_t g_pipe_transposed[N_BINS];
static q15_t      g_time_out[N_FFT];
